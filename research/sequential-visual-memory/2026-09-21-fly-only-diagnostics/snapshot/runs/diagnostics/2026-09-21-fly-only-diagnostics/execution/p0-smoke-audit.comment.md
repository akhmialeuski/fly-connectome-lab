### Sequential execution: `p0-smoke-audit`
...
```json
{
  ...
  "cross_split_duplicate_candidates": 2,
  ...
  "identities_with_three_reserved": 11
}
```

Working evidence: `$FLYSTATE_HOME/runs/diagnostics/2026-09-21-fly-only-diagnostics/p0-smoke-audit/`. Full coefficients, predictions, provenance, and checksums will be archived in the sibling study directory. No final-test predictions were scored. This remains exploratory.
